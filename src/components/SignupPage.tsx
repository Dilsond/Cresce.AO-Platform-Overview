...
export function SignupPage({ onSignup, onNavigateToLogin, onBack }: SignupPageProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (authData.user) {
        // 3. Inserir dados na tabela usuarios_normais
          ...
          .insert([
            {
              ...
              nome_utilizador: username,
              email: email,
              // A senha já está no Auth, não precisamos guardar aqui
            }
          ]);
        ...
        // Aguardar 2 segundos e chamar o onSignup
        setTimeout(() => {
      ...
      if (error.message.includes('duplicate key') || error.message.includes('já está em uso')) {
        setError('Este e-mail ou nome de utilizador já está registrado');
          ...
          <div className="lg:w-1/2 p-12 flex flex-col justify-center">
            ...
            >
              ...
              <div className="grid grid-cols-3 gap-3">
                <button 
                  type="button"
                  onClick={() => {/* Implementar cadastro com GitHub */}}
                ...
                <button 
                  type="button"
                  onClick={() => {/* Implementar cadastro com Google */}}
                  className="px-4 py-2.5 border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors flex items-center justify-center"
                >
                ...
                <button 
                  type="button"
                  onClick={() => {/* Implementar cadastro com Facebook */}}
                  className="px-4 py-2.5 border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors flex items-center justify-center"
                >
