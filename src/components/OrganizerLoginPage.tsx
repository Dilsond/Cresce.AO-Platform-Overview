                ...
                <div className="flex flex-col lg:flex-row min-h-[500px]">
                    ...
                    <div className="lg:hidden bg-orange-600 px-6 py-8 text-white relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-white/80 text-sm mb-1">Para organizadores</p>
                    ...
                    <div className="lg:w-1/2 p-6 sm:p-8 lg:p-12 flex flex-col justify-center">
                        ...
                        >
                            ...
                            <form onSubmit={handleLoginSubmit} className="space-y-4 sm:space-y-5">
                                ...
                                <div>
                                    <label htmlFor="loginPassword" className="block text-sm font-medium text-gray-700 mb-3">
                                        Senha
                                    </label>
                                ...
                                <motion.button
                                    type="submit"
                                    disabled={isLoading}
                                    className="w-full bg-orange-600 text-white py-3 sm:py-3.5 cursor-pointer rounded-xl font-semibold hover:bg-orange-700 transition-all shadow-lg shadow-orange-500/30 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 text-sm sm:text-base"
                            ...
                            <div className=" sm:mt-6 text-center pt-5 sm:pt-6 border-t border-gray-100">
                                <p className="text-sm sm:text-base text-gray-600 mt-2">
                                    Ainda não tem conta de organizador?
                                </p>
                                <button
                                    onClick={() => { navigate('/organizer-signup'); setShowPassword(false); }}
                                    className="text-orange-600 cursor-pointer font-semibold hover:text-orange-700 transition-colors text-sm sm:text-base"
                                >
                                    Criar uma conta
                                </button>
                            </div>
