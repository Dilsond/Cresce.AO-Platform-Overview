// Dados dos slides para a LandingPage
import angoticImage from 'figma:asset/2b98f25257b1238c48d47c9236d12c5ed6e3cffe.png';

export const landingPageSlides = [
  {
    id: 19,
    title: 'ANGOTIC 2026 - Congresso de Tecnologias de Informação',
    description: 'O maior congresso de tecnologias de informação e comunicação de Angola. Reúne especialistas nacionais e internacionais para discutir inovação, cibersegurança, IA e transformação digital.',
    category: 'Feira',
    eventType: 'Híbrido',
    date: '15 Mai 2026',
    time: '08:30',
  ...
  },
  {
    ...
    description: 'Aprenda estratégias práticas para transformar ideias em negócios digitais lucrativos.',
    category: 'Workshop',
  ...
  {
    id: 2,
    title: 'Palestra: O Futuro do Trabalho em Angola',
    description: 'Discussão sobre tendências do mercado de trabalho e oportunidades para jovens profissionais.',
    category: 'Palestra',
    eventType: 'Online',
    date: '28 Jan 2026',
    time: '10:00',
  ...
  {
    id: 3,
    title: 'Feira de Oportunidades Profissionais 2026',
    description: 'Conecte-se com as principais empresas de Angola. Vagas de emprego, estágios e networking.',
    category: 'Feira',
    eventType: 'Presencial',
    date: '10 Fev 2026',
    time: '09:00',
  ...
  {
    id: 4,
    title: 'Masterclass de Transformação Digital',
    description: 'Participe presencialmente ou online. Aprenda com especialistas internacionais e cases locais.',
    ...
    price: 'Gratuito',
    image: 'https://images.unsplash.com/photo-1731087357396-0fbd4fd3ab23?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxoeWJyaWQlMjBtZWV0aW5nJTIwdGVjaG5vbG9neSUyMGNvbmZlcmVuY2V8ZW58MXx8fHwxNzY4MzAwNDMwfDA&ixlib=rb-4.1.0&q=80&w=1080'
  },
  {
    id: 5,
    title: 'Conferência de Liderança e Gestão',
    description: 'Conferência exclusiva com palestrantes internacionais sobre liderança estratégica e gestão de equipas.',
    category: 'Palestra',
    eventType: 'Presencial',
    date: '15 Fev 2026',
    time: '09:00',
  ...
  },
  {
    ...
    description: 'Workshop gratuito sobre as últimas tendências em tecnologia, IA e blockchain.',
    category: 'Workshop',
    eventType: 'Online',
    date: '20 Fev 2026',
    time: '14:30',
  ...
  {
    id: 7,
    title: 'Conferência Angola Business Summit 2026',
    description: 'O maior evento de negócios de Angola. Conecte-se com líderes empresariais e investidores.',
    category: 'Palestra',
    eventType: 'Presencial',
    date: '31 Jan 2026',
    time: '09:00',
  ...
  {
    id: 8,
    title: 'Workshop de Gestão Corporativa',
    description: 'Workshop intensivo sobre gestão corporativa moderna e liderança eficaz.',
    category: 'Workshop',
    eventType: 'Presencial',
    date: '04 Fev 2026',
    time: '14:00',
    location: 'CESE - Centro de Estudos Sociais',
    price: '25.000 Kz',
  ...
  {
    id: 9,
    title: 'Feira de Tecnologia e Inovação Angola Tech',
    description: 'A maior feira de tecnologia de Angola. Exposição de startups e produtos inovadores.',
    category: 'Feira',
    eventType: 'Presencial',
    date: '18 Fev 2026',
    time: '10:00',
  ...
  {
    id: 10,
    title: 'Seminário de Finanças Empresariais',
    description: 'Seminário especializado em gestão financeira e investimentos corporativos.',
    category: 'Palestra',
    eventType: 'Presencial',
    date: '25 Fev 2026',
    time: '09:00',
  ...
  {
    id: 11,
    title: 'Workshop de Marketing Digital e Redes Sociais',
    description: 'Aprenda estratégias de marketing digital e gestão de redes sociais para impulsionar o seu negócio.',
    category: 'Workshop',
    eventType: 'Híbrido',
    date: '12 Fev 2026',
    time: '14:00',
    location: 'Luanda Business Center',
    price: '22.000 Kz',
  ...
  {
    id: 12,
    title: 'Bootcamp de Programação Full-Stack',
    description: 'Bootcamp intensivo de programação. Aprenda JavaScript, React, Node.js e bases de dados.',
    category: 'Workshop',
    eventType: 'Presencial',
    date: '01 Mar 2026',
    time: '09:00',
    location: 'ETIC - Escola de Tecnologias',
    price: '85.000 Kz',
...
// Dados para seções de scroll horizontal
export const cursosWorkshops = [
  {
    id: '7',
    title: 'Conferência Angola Business Summit 2026',
    location: 'Hotel Presidente - Luanda',
...
export const eventosNegocios = [
  ...
  {
    id: '14',
    title: 'Feira de Empreendedorismo e Startups',
  ...
  {
    id: '18',
    title: 'Networking Profissional - Encontro de Negócios',
